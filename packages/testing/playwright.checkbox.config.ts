...
export default defineConfig({
 ...docs,
 testDir: './browser', testMatch: ['Checkbox/*.spec.ts'],
 projects: [{ name: 'docs' }, { name: 'example', grepInvert: /checkbox.browser.(dev|ssr)/, use: { baseURL: 'http://127.0.0.1:4174/' } }],
 ...
 outputDir: './test-results/checkbox',
})
