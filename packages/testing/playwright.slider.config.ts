...
export default defineConfig({
 ...docs,
 testDir: './browser', testMatch: ['Slider/*.spec.ts'],
 projects: [{ name: 'docs' }, { name: 'example', grepInvert: /slider.browser.(dev|ssr)/, use: { baseURL: 'http://127.0.0.1:4174/' } }],
