...
export default defineConfig({
 ...docs,
 testDir: './browser', testMatch: ['Radio/*.spec.ts'],
 projects: [{ name: 'docs' }, { name: 'example', grepInvert: /radio.browser.(dev|ssr)/, use: { baseURL: 'http://127.0.0.1:4174/' } }],
