...
export default defineConfig({
 ...docs,
 testDir: './browser', testMatch: ['Switch/*.spec.ts'],
 projects: [{ name: 'docs' }, { name: 'example', grepInvert: /switch.browser.(dev|ssr)/, use: { baseURL: 'http://127.0.0.1:4174/' } }],
