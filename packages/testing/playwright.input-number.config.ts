...
export default defineConfig({
 ...docs,
 testDir: './browser', testMatch: ['InputNumber/*.spec.ts'],
 projects: [{ name: 'docs' }, { name: 'example', grepInvert: /input-number.browser.(dev|ssr)/, use: { baseURL: 'http://127.0.0.1:4174/' } }],
 ...
 outputDir: './test-results/input-number',
})
