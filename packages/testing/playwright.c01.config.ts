...
export default defineConfig({
  ...docs,
  testDir: './browser',
  testMatch: ['Icon/*.spec.ts', 'ConfigProvider/*.spec.ts', '_VirtualList/*.spec.ts'],
  projects: [{name:'docs',testIgnore:'**/_VirtualList/**'}, {name:'example',use:{baseURL:'http://127.0.0.1:4174/'}}],
